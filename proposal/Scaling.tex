...
The \red{blue} line shows a set of fiducial simulations that use only the
...
The \red{orange} line shows the scaling for the fiducial \nameTurbulence\
...
The \red{green} curve shows the weak scaling for the fiducial \nameCores\
